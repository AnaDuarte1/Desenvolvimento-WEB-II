...
-- produtos
insert into produto (id, descricao, preco, estoque) values (1, 'Teclado USB', 142.50, 10);
insert into produto (id, descricao, preco, estoque) values (2, 'Fone Bluetooth', 175, 5);
insert into produto (id, descricao, preco, estoque) values (3, 'Pen drive', 62.10, 20);
insert into produto (id, descricao, preco, estoque) values (4, 'Monitor HDMI', 780, 2);
